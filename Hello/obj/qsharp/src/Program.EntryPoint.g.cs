...
namespace Hello
{
    ...
    internal class __QsEntryPoint__ : Microsoft.Quantum.CsharpGeneration.EntryPointDriver.IEntryPoint<QVoid, QVoid>
    {
        ...
        public EntryPointInfo<QVoid, QVoid> Info => Hello.HelloQ.Info;
        ...
        private static async System.Threading.Tasks.Task<int> Main(string[] args) => await new Microsoft.Quantum.CsharpGeneration.EntryPointDriver.Driver<Hello.HelloQ, QVoid, QVoid>(new __QsEntryPoint__()).Run(args);
    }
}